...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-9 items-center justify-start rounded-lg bg-[#EFEDE7] p-1 text-muted-foreground gap-0.5",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Trigger
    ...
    className={cn(
      ...
      "data-[state=active]:bg-white data-[state=active]:text-[#1B3A5C] data-[state=active]:shadow-card data-[state=active]:font-semibold",
